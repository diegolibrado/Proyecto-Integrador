...
public class VentanaOficial extends JFrame {
	...
	private void inicializarComponentes() {
		JLabel lblMenuOficial = new JLabel("MENÚ OFICIAL");
		lblMenuOficial.setHorizontalAlignment(SwingConstants.CENTER);
		lblMenuOficial.setFont(new Font("Tahoma", Font.BOLD, 34));
		lblMenuOficial.setBounds(27, 63, 298, 40);
		getContentPane().add(lblMenuOficial);
